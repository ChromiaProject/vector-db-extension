...
import net.postchain.gtx.extensions.vectordb.VectorDBEmbeddingComputeEngineGCP
...
object EmbeddingHelper {
    fun embeddingComputeEngine(nodeConfig: String): VectorDBEmbeddingComputeEngine {
    ...
    fun embeddingComputeGCPEngine(nodeConfig: String): VectorDBEmbeddingComputeEngineGCP {
        val configuration = mock<BlockchainConfiguration> {
            on { rawConfig } doReturn gtv(mapOf(
                    VectorDbGTXModule.VECTOR_DB_EXTENSION_CONFIG_NAME to
                            gtv(mapOf("embedding_compute" to GtvObjectMapper.toGtvDictionary(VectorDbEmbeddingComputeConfig(
        ...
        val service = VectorDBEmbeddingComputeEngineGCP()
